...
kind of render. Definitions live in `.claude/commands/recipe/<genre>.md`
...
1. List `.claude/commands/recipe/` for the available genres, each with
...
1. Resolve `.claude/commands/recipe/$1.md`. If it does not exist,

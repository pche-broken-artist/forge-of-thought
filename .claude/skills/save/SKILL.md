...
A light check fit for a save (ledger bookkeeping, version and status
agreement, the companion row) is a kind of check and is added here
once the kinds of THR.0290 exist; until then a save is unchecked,
knowingly (POS.0570), and the full check runs at the release.

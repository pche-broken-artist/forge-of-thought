...
7. **Renders** are audience-specific outputs generated from the chain —
   ...
   ledger's Renders table mirrors the provenance.
...
| `/recipe [genre] [slug]` | bare = genre roster; with a genre (e.g. `presentation`), guided composition — or iteration — of a render recipe from the genre's elicitation checklist and skeleton |

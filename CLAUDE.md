...
Unreleased head is regenerated by every `/release` of the engine and
is recast as the new major's section at approval; released sections
are carried over verbatim and never change retroactively.
